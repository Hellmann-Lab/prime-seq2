...
for (c in conditions) {
  ...
  barcode_file <- paste0("/home/felix/prime-seq_NextGen/data/FC2024_08_01_poolsize/03b_zUMIs_downsampled/BCs_", c, ".txt")
...
write.table(df_counts, "counts_antisense_intergenics_downsampled_poolsize.txt", sep = "\t", row.names = FALSE, quote = FALSE)
