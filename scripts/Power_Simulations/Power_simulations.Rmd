...
```{r}
here:i_am("scripts/Power_Simulations/Power_simulations.Rmd")
...
batch_info_old <- data.frame(batches = c(rep("a", 8), 
                                     rep("b", 8), 
                                     rep("c", 8), 
                                     rep("d", 8)
                                     ))
...
saveRDS(estparam_old, file = here("scripts/Power_Simulations/pow_parameters_old.rds"))
estparam_old <- readRDS(here("scripts/Power_Simulations/pow_parameters_old.rds"))
...
saveRDS(estparam_PTO, file = here("scripts/Power_Simulations/pow_parameter_PTO.rds"))
estparam_PTO <- readRDS(here("scripts/Power_Simulations/pow_parameters_PTO.rds"))
...
saveRDS(simres_old, file = here("scripts/Power_Simulations/pow_simulated_old.rds"))
simres_old <- readRDS(here("scripts/Power_Simulations/pow_simulated_old.rds"))
...
saveRDS(simres_PTO, file = here("scripts/Power_Simulations/pow_simulated_PTO.rds"))
simres_PTO <- readRDS(here("scripts/Power_Simulations/pow_simulated_PTO.rds"))
```
...
saveRDS(df_mean, 
        file = here("scripts/Power_Simulations/marginal_data.rds"))
...
saveRDS(df_rates_lfc, 
        file = here("scripts/Power_Simulations/conditional_lfc.rds"))
...
saveRDS(df_rates_mean, 
        file = here("scripts/Power_Simulations/conditional_mean.rds"))
