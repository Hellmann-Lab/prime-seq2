...
# 1 get data ----
## 1.1 window counts ----
window_files <- list.files("/data/share/htp/prime-seq_NextGen/intergenics_analysis/output", pattern = "_window_counts.txt$", full.names = TRUE)
...
p0 <- combined_reads %>% 
  ...
  labs(x = "Sample and Read Group", 
       ...
       subtitle = "Includes Intergenic, Exon, and Intron reads") +
  scale_fill_manual(values = pool_colors)
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/00_total_reads_per_condition_and_rg.pdf", 
...
p1
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/01_window_counts_normalized_by_intergenic.pdf", 
       p1, width = 8, height = 6)
...
p2 <- ggplot(sorted_data %>% filter(tile_by_count <=50)
  ...
  scale_color_manual(values = pool_colors)
p2
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/02_cumulative_window_counts_normalized_by_intergenic.pdf", 
       p2, width = 8, height = 6)
...
p3 <- ggplot(sorted_data_umis %>% filter(tile_by_count <=50)
  ...
  scale_color_manual(values = pool_colors)
p3
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/03_window_counts_umis_normalized_by_intergenic.pdf", 
       p3, width = 8, height = 6)
...
p4 <- ggplot(sorted_data_umis %>% filter(tile_by_count <=50)
  ...
  scale_color_manual(values = pool_colors)
p4
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/04_cumulative_window_counts_umis_normalized_by_intergenic.pdf", 
       p4, width = 8, height = 6)
...
p5 <- ggplot(sorted_data2 %>% filter(tile_by_count <=50)
  ...
  scale_color_manual(values = pool_colors)
p5
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/05_window_counts_normalized_by_total.pdf", 
       p5, width = 8, height = 6)
...
p6 <- ggplot(sorted_data2 %>% filter(tile_by_count <=50)
  ...
  scale_color_manual(values = pool_colors)
p6
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/06_cumulative_window_counts_normalized_by_total.pdf", 
       p6, width = 8, height = 6)
...
p7 <- ggplot(sorted_data2_umis %>% filter(tile_by_count <=50)
  ...
  scale_color_manual(values = pool_colors)
p7
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/07_window_counts_umis_normalized_by_total.pdf", 
       p7, width = 8, height = 6)
...
p8 <- ggplot(sorted_data2_umis %>% filter(tile_by_count <=50)
  ...
  scale_color_manual(values = pool_colors)
p8
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/08_cumulative_window_counts_umis_normalized_by_total.pdf", 
       p8, width = 8, height = 6)
...
write.table(top_each, 
            "/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/top_100_windows_per_condition.txt",
...
write.table(top_all %>%
              slice_head(n=100), 
            "/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/top_100_windows_mean_across_conditions.txt",
            sep="\t", quote=FALSE, row.names=FALSE)
...
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/09_top_25_windows_mean_by_mean.pdf", 
...
p10 <- top_all %>%
  ...
  labs(x = "Window rank (equal across conditions)", y = "Mean Normalized UMIs", 
       ...
       subtitle = "Normalized by Condition In+Ex+Inter") +
  scale_color_manual(values = pool_colors)
ggsave("/data/share/htp/prime-seq_NextGen/intergenics_analysis/plot/10_top_50_windows_by_mean.pdf", 
